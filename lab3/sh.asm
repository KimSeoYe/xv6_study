...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
    ...
    1020:	6a 02                	push   $0x2
    1022:	68 a5 22 00 00       	push   $0x22a5
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    1038:	80 3d 02 29 00 00 20 	cmpb   $0x20,0x2902
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    1089:	68 2e 22 00 00       	push   $0x222e
  ...
  exit();
    ...
    10a9:	68 00 29 00 00       	push   $0x2900
    ...
    10be:	68 00 29 00 00       	push   $0x2900
    10c3:	e8 78 0a 00 00       	call   1b40 <strlen>
      if(chdir(buf+3) < 0)
    10c8:	c7 04 24 03 29 00 00 	movl   $0x2903,(%esp)
      buf[strlen(buf)-1] = 0;  // chop \n
    10cf:	c6 80 ff 28 00 00 00 	movb   $0x0,0x28ff(%eax)
      if(chdir(buf+3) < 0)
    ...
    10e6:	50                   	push   %eax
    10e7:	68 03 29 00 00       	push   $0x2903
    10ec:	68 ad 22 00 00       	push   $0x22ad
    10f1:	6a 02                	push   $0x2
    10f3:	e8 78 0d 00 00       	call   1e70 <printf>
...
00001100 <getcmd>:
{
  ...
  printf(2, "$ ");
    ...
    110e:	68 04 22 00 00       	push   $0x2204
    1113:	6a 02                	push   $0x2
    1115:	e8 56 0d 00 00       	call   1e70 <printf>
  memset(buf, 0, nbuf);
...
00001150 <panic>:
{
  ...
  printf(2, "%s\n", s);
    ...
    1159:	68 a1 22 00 00       	push   $0x22a1
    115e:	6a 02                	push   $0x2
    1160:	e8 0b 0d 00 00       	call   1e70 <printf>
  exit();
...
00001170 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    1189:	ff 24 85 bc 22 00 00 	jmp    *0x22bc(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    11a9:	68 0e 22 00 00       	push   $0x220e
    11ae:	6a 02                	push   $0x2
    11b0:	e8 bb 0c 00 00       	call   1e70 <printf>
    break;
  ...
  if(pid == -1)
    ...
    11fd:	68 1e 22 00 00       	push   $0x221e
    1202:	6a 02                	push   $0x2
    1204:	e8 67 0c 00 00       	call   1e70 <printf>
      exit();
  ...
  if(pid == -1)
    ...
    1290:	68 07 22 00 00       	push   $0x2207
    1295:	e8 b6 fe ff ff       	call   1150 <panic>
    panic("fork");
    129a:	83 ec 0c             	sub    $0xc,%esp
    129d:	68 2e 22 00 00       	push   $0x222e
    ...
    12d8:	68 33 22 00 00       	push   $0x2233
...
00001310 <fork1>:
{
  ...
  return pid;
    ...
    1325:	68 2e 22 00 00       	push   $0x222e
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
    ...
    1339:	e8 92 0d 00 00       	call   20d0 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
    ...
    1369:	e8 62 0d 00 00       	call   20d0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
    13b7:	6a 0c                	push   $0xc
    13b9:	e8 12 0d 00 00       	call   20d0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
    13f7:	6a 0c                	push   $0xc
    13f9:	e8 d2 0c 00 00       	call   20d0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
    1437:	6a 08                	push   $0x8
    1439:	e8 92 0c 00 00       	call   20d0 <malloc>
  memset(cmd, 0, sizeof(*cmd));
    ...
    1469:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    148d:	50                   	push   %eax
    148e:	68 f8 28 00 00       	push   $0x28f8
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    14dd:	50                   	push   %eax
    14de:	68 f8 28 00 00       	push   $0x28f8
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    1536:	50                   	push   %eax
    1537:	68 f0 28 00 00       	push   $0x28f0
    ...
    1555:	50                   	push   %eax
    1556:	68 f8 28 00 00       	push   $0x28f8
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    15fd:	50                   	push   %eax
    15fe:	68 f8 28 00 00       	push   $0x28f8
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    1653:	68 55 22 00 00       	push   $0x2255
    1658:	53                   	push   %ebx
    1659:	56                   	push   %esi
  ...
  return cmd;
    ...
    16de:	68 38 22 00 00       	push   $0x2238
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
    16ff:	68 58 22 00 00       	push   $0x2258
    1704:	57                   	push   %edi
    1705:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    174e:	68 6f 22 00 00       	push   $0x226f
    1753:	57                   	push   %edi
    1754:	56                   	push   %esi
    ...
    1798:	68 61 22 00 00       	push   $0x2261
  ...
  cmd->eargv[argc] = 0;
    ...
    17ea:	68 5a 22 00 00       	push   $0x225a
...
00001800 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
    181b:	68 74 22 00 00       	push   $0x2274
    1820:	56                   	push   %esi
    1821:	53                   	push   %ebx
...
00001870 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
    ...
    18ab:	68 76 22 00 00       	push   $0x2276
    18b0:	56                   	push   %esi
    18b1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
    ...
    18c1:	68 72 22 00 00       	push   $0x2272
    18c6:	56                   	push   %esi
    18c7:	53                   	push   %ebx
...
00001910 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
    191f:	68 58 22 00 00       	push   $0x2258
    1924:	56                   	push   %esi
    1925:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
    194b:	68 94 22 00 00       	push   $0x2294
    1950:	56                   	push   %esi
    1951:	53                   	push   %ebx
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
    ...
    19b5:	ff 24 85 d4 22 00 00 	jmp    *0x22d4(,%eax,4)
...
00001a50 <parsecmd>:
{
  ...
  peek(&s, es, "");
    ...
    1a77:	68 1d 22 00 00       	push   $0x221d
    1a7c:	53                   	push   %ebx
    1a7d:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    1a9f:	52                   	push   %edx
    1aa0:	50                   	push   %eax
    1aa1:	68 96 22 00 00       	push   $0x2296
    1aa6:	6a 02                	push   $0x2
    1aa8:	e8 c3 03 00 00       	call   1e70 <printf>
    panic("syntax");
    1aad:	c7 04 24 5a 22 00 00 	movl   $0x225a,(%esp)
...
{
    1ddb:	89 45 c0             	mov    %eax,-0x40(%ebp)
    neg = 1;
    x = -xx;
    1dde:	89 d0                	mov    %edx,%eax
  if(sgn && xx < 0){
    1de0:	79 76                	jns    1e58 <printint+0x88>
    1de2:	f6 45 08 01          	testb  $0x1,0x8(%ebp)
    1de6:	74 70                	je     1e58 <printint+0x88>
    x = -xx;
    1de8:	f7 d8                	neg    %eax
    neg = 1;
    1dea:	c7 45 c4 01 00 00 00 	movl   $0x1,-0x3c(%ebp)
  } else {
    x = xx;
  }

  i = 0;
    1df1:	31 f6                	xor    %esi,%esi
    1df3:	8d 5d d7             	lea    -0x29(%ebp),%ebx
    1df6:	eb 0a                	jmp    1e02 <printint+0x32>
    1df8:	90                   	nop
    1df9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  do{
    buf[i++] = digits[x % base];
    1e00:	89 fe                	mov    %edi,%esi
    1e02:	31 d2                	xor    %edx,%edx
    1e04:	8d 7e 01             	lea    0x1(%esi),%edi
    1e07:	f7 f1                	div    %ecx
    1e09:	0f b6 92 f4 22 00 00 	movzbl 0x22f4(%edx),%edx
  }while((x /= base) != 0);
    1e10:	85 c0                	test   %eax,%eax
    buf[i++] = digits[x % base];
    1e12:	88 14 3b             	mov    %dl,(%ebx,%edi,1)
  }while((x /= base) != 0);
    1e15:	75 e9                	jne    1e00 <printint+0x30>
  if(neg)
    1e17:	8b 45 c4             	mov    -0x3c(%ebp),%eax
    1e1a:	85 c0                	test   %eax,%eax
    1e1c:	74 08                	je     1e26 <printint+0x56>
    buf[i++] = '-';
    1e1e:	c6 44 3d d8 2d       	movb   $0x2d,-0x28(%ebp,%edi,1)
    1e23:	8d 7e 02             	lea    0x2(%esi),%edi
    1e26:	8d 74 3d d7          	lea    -0x29(%ebp,%edi,1),%esi
    1e2a:	8b 7d c0             	mov    -0x40(%ebp),%edi
    1e2d:	8d 76 00             	lea    0x0(%esi),%esi
    1e30:	0f b6 06             	movzbl (%esi),%eax
  write(fd, &c, 1);
    1e33:	83 ec 04             	sub    $0x4,%esp
    1e36:	83 ee 01             	sub    $0x1,%esi
    1e39:	6a 01                	push   $0x1
    1e3b:	53                   	push   %ebx
    1e3c:	57                   	push   %edi
    1e3d:	88 45 d7             	mov    %al,-0x29(%ebp)
    1e40:	e8 ed fe ff ff       	call   1d32 <write>

  while(--i >= 0)
    1e45:	83 c4 10             	add    $0x10,%esp
    1e48:	39 de                	cmp    %ebx,%esi
    1e4a:	75 e4                	jne    1e30 <printint+0x60>
    putc(fd, buf[i]);
}
  ...
  neg = 0;
    1e58:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
    1e5f:	eb 90                	jmp    1df1 <printint+0x21>
    1e61:	eb 0d                	jmp    1e70 <printf>
    1e63:	90                   	nop
    1e64:	90                   	nop
    1e65:	90                   	nop
    1e66:	90                   	nop
...
printf(int fd, char *fmt, ...)
{
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    1e79:	8b 75 0c             	mov    0xc(%ebp),%esi
    1e7c:	0f b6 1e             	movzbl (%esi),%ebx
    1e7f:	84 db                	test   %bl,%bl
    1e81:	0f 84 b3 00 00 00    	je     1f3a <printf+0xca>
  ap = (uint*)(void*)&fmt + 1;
    1e87:	8d 45 10             	lea    0x10(%ebp),%eax
    1e8a:	83 c6 01             	add    $0x1,%esi
  state = 0;
    1e8d:	31 ff                	xor    %edi,%edi
  ap = (uint*)(void*)&fmt + 1;
    1e8f:	89 45 d4             	mov    %eax,-0x2c(%ebp)
    1e92:	eb 2f                	jmp    1ec3 <printf+0x53>
    1e94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
    1e98:	83 f8 25             	cmp    $0x25,%eax
    1e9b:	0f 84 a7 00 00 00    	je     1f48 <printf+0xd8>
  write(fd, &c, 1);
    1ea1:	8d 45 e2             	lea    -0x1e(%ebp),%eax
    1ea4:	83 ec 04             	sub    $0x4,%esp
    1ea7:	88 5d e2             	mov    %bl,-0x1e(%ebp)
    1eaa:	6a 01                	push   $0x1
    1eac:	50                   	push   %eax
    1ead:	ff 75 08             	pushl  0x8(%ebp)
    1eb0:	e8 7d fe ff ff       	call   1d32 <write>
    1eb5:	83 c4 10             	add    $0x10,%esp
    1eb8:	83 c6 01             	add    $0x1,%esi
  for(i = 0; fmt[i]; i++){
    1ebb:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
    1ebf:	84 db                	test   %bl,%bl
    1ec1:	74 77                	je     1f3a <printf+0xca>
    if(state == 0){
    1ec3:	85 ff                	test   %edi,%edi
    c = fmt[i] & 0xff;
    1ec5:	0f be cb             	movsbl %bl,%ecx
    1ec8:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    1ecb:	74 cb                	je     1e98 <printf+0x28>
        state = '%';
      } else {
        putc(fd, c);
      }
    } else if(state == '%'){
    1ecd:	83 ff 25             	cmp    $0x25,%edi
    1ed0:	75 e6                	jne    1eb8 <printf+0x48>
      if(c == 'd'){
    1ed2:	83 f8 64             	cmp    $0x64,%eax
    1ed5:	0f 84 05 01 00 00    	je     1fe0 <printf+0x170>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    1edb:	81 e1 f7 00 00 00    	and    $0xf7,%ecx
    1ee1:	83 f9 70             	cmp    $0x70,%ecx
    1ee4:	74 72                	je     1f58 <printf+0xe8>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    1ee6:	83 f8 73             	cmp    $0x73,%eax
    1ee9:	0f 84 99 00 00 00    	je     1f88 <printf+0x118>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    1eef:	83 f8 63             	cmp    $0x63,%eax
    1ef2:	0f 84 08 01 00 00    	je     2000 <printf+0x190>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    1ef8:	83 f8 25             	cmp    $0x25,%eax
    1efb:	0f 84 ef 00 00 00    	je     1ff0 <printf+0x180>
  write(fd, &c, 1);
    1f01:	8d 45 e7             	lea    -0x19(%ebp),%eax
    1f04:	83 ec 04             	sub    $0x4,%esp
    1f07:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    1f0b:	6a 01                	push   $0x1
    1f0d:	50                   	push   %eax
    1f0e:	ff 75 08             	pushl  0x8(%ebp)
    1f11:	e8 1c fe ff ff       	call   1d32 <write>
    1f16:	83 c4 0c             	add    $0xc,%esp
    1f19:	8d 45 e6             	lea    -0x1a(%ebp),%eax
    1f1c:	88 5d e6             	mov    %bl,-0x1a(%ebp)
    1f1f:	6a 01                	push   $0x1
    1f21:	50                   	push   %eax
    1f22:	ff 75 08             	pushl  0x8(%ebp)
    1f25:	83 c6 01             	add    $0x1,%esi
      ...
      state = 0;
    1f28:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
    1f2a:	e8 03 fe ff ff       	call   1d32 <write>
  for(i = 0; fmt[i]; i++){
    1f2f:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
  write(fd, &c, 1);
    1f33:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    1f36:	84 db                	test   %bl,%bl
    1f38:	75 89                	jne    1ec3 <printf+0x53>
    }
  }
}
    1f3a:	8d 65 f4             	lea    -0xc(%ebp),%esp
    1f3d:	5b                   	pop    %ebx
    1f3e:	5e                   	pop    %esi
    1f3f:	5f                   	pop    %edi
    1f40:	5d                   	pop    %ebp
    1f41:	c3                   	ret    
    1f42:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        state = '%';
    1f48:	bf 25 00 00 00       	mov    $0x25,%edi
    1f4d:	e9 66 ff ff ff       	jmp    1eb8 <printf+0x48>
    1f52:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        printint(fd, *ap, 16, 0);
    1f58:	83 ec 0c             	sub    $0xc,%esp
    1f5b:	b9 10 00 00 00       	mov    $0x10,%ecx
    1f60:	6a 00                	push   $0x0
    1f62:	8b 7d d4             	mov    -0x2c(%ebp),%edi
    1f65:	8b 45 08             	mov    0x8(%ebp),%eax
    1f68:	8b 17                	mov    (%edi),%edx
    1f6a:	e8 61 fe ff ff       	call   1dd0 <printint>
        ap++;
    1f6f:	89 f8                	mov    %edi,%eax
    1f71:	83 c4 10             	add    $0x10,%esp
      state = 0;
    1f74:	31 ff                	xor    %edi,%edi
        ap++;
    1f76:	83 c0 04             	add    $0x4,%eax
    1f79:	89 45 d4             	mov    %eax,-0x2c(%ebp)
    1f7c:	e9 37 ff ff ff       	jmp    1eb8 <printf+0x48>
    1f81:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        s = (char*)*ap;
    1f88:	8b 45 d4             	mov    -0x2c(%ebp),%eax
    1f8b:	8b 08                	mov    (%eax),%ecx
        ap++;
    1f8d:	83 c0 04             	add    $0x4,%eax
    1f90:	89 45 d4             	mov    %eax,-0x2c(%ebp)
        if(s == 0)
    1f93:	85 c9                	test   %ecx,%ecx
    1f95:	0f 84 8e 00 00 00    	je     2029 <printf+0x1b9>
        while(*s != 0){
    1f9b:	0f b6 01             	movzbl (%ecx),%eax
      state = 0;
    1f9e:	31 ff                	xor    %edi,%edi
        s = (char*)*ap;
    1fa0:	89 cb                	mov    %ecx,%ebx
        while(*s != 0){
    1fa2:	84 c0                	test   %al,%al
    1fa4:	0f 84 0e ff ff ff    	je     1eb8 <printf+0x48>
    1faa:	89 75 d0             	mov    %esi,-0x30(%ebp)
    1fad:	89 de                	mov    %ebx,%esi
    1faf:	8b 5d 08             	mov    0x8(%ebp),%ebx
    1fb2:	8d 7d e3             	lea    -0x1d(%ebp),%edi
    1fb5:	8d 76 00             	lea    0x0(%esi),%esi
  write(fd, &c, 1);
    1fb8:	83 ec 04             	sub    $0x4,%esp
          s++;
    1fbb:	83 c6 01             	add    $0x1,%esi
    1fbe:	88 45 e3             	mov    %al,-0x1d(%ebp)
  write(fd, &c, 1);
    1fc1:	6a 01                	push   $0x1
    1fc3:	57                   	push   %edi
    1fc4:	53                   	push   %ebx
    1fc5:	e8 68 fd ff ff       	call   1d32 <write>
        while(*s != 0){
    1fca:	0f b6 06             	movzbl (%esi),%eax
    1fcd:	83 c4 10             	add    $0x10,%esp
    1fd0:	84 c0                	test   %al,%al
    1fd2:	75 e4                	jne    1fb8 <printf+0x148>
    1fd4:	8b 75 d0             	mov    -0x30(%ebp),%esi
      state = 0;
    1fd7:	31 ff                	xor    %edi,%edi
    1fd9:	e9 da fe ff ff       	jmp    1eb8 <printf+0x48>
    1fde:	66 90                	xchg   %ax,%ax
        printint(fd, *ap, 10, 1);
    1fe0:	83 ec 0c             	sub    $0xc,%esp
    1fe3:	b9 0a 00 00 00       	mov    $0xa,%ecx
    1fe8:	6a 01                	push   $0x1
    1fea:	e9 73 ff ff ff       	jmp    1f62 <printf+0xf2>
    1fef:	90                   	nop
  write(fd, &c, 1);
    1ff0:	83 ec 04             	sub    $0x4,%esp
    1ff3:	88 5d e5             	mov    %bl,-0x1b(%ebp)
    1ff6:	8d 45 e5             	lea    -0x1b(%ebp),%eax
    1ff9:	6a 01                	push   $0x1
    1ffb:	e9 21 ff ff ff       	jmp    1f21 <printf+0xb1>
        putc(fd, *ap);
    2000:	8b 7d d4             	mov    -0x2c(%ebp),%edi
  write(fd, &c, 1);
    2003:	83 ec 04             	sub    $0x4,%esp
        putc(fd, *ap);
    2006:	8b 07                	mov    (%edi),%eax
  write(fd, &c, 1);
    2008:	6a 01                	push   $0x1
        ap++;
    200a:	83 c7 04             	add    $0x4,%edi
        putc(fd, *ap);
    200d:	88 45 e4             	mov    %al,-0x1c(%ebp)
  write(fd, &c, 1);
    2010:	8d 45 e4             	lea    -0x1c(%ebp),%eax
    2013:	50                   	push   %eax
    2014:	ff 75 08             	pushl  0x8(%ebp)
    2017:	e8 16 fd ff ff       	call   1d32 <write>
        ap++;
    201c:	89 7d d4             	mov    %edi,-0x2c(%ebp)
    201f:	83 c4 10             	add    $0x10,%esp
      state = 0;
    2022:	31 ff                	xor    %edi,%edi
    2024:	e9 8f fe ff ff       	jmp    1eb8 <printf+0x48>
          s = "(null)";
    2029:	bb ec 22 00 00       	mov    $0x22ec,%ebx
        while(*s != 0){
    202e:	b8 28 00 00 00       	mov    $0x28,%eax
    2033:	e9 72 ff ff ff       	jmp    1faa <printf+0x13a>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    2041:	a1 64 29 00 00       	mov    0x2964,%eax
{
    2046:	89 e5                	mov    %esp,%ebp
    2048:	57                   	push   %edi
    2049:	56                   	push   %esi
    204a:	53                   	push   %ebx
    204b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  bp = (Header*)ap - 1;
    204e:	8d 4b f8             	lea    -0x8(%ebx),%ecx
    2051:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    2058:	39 c8                	cmp    %ecx,%eax
    205a:	8b 10                	mov    (%eax),%edx
    205c:	73 32                	jae    2090 <free+0x50>
    205e:	39 d1                	cmp    %edx,%ecx
    2060:	72 04                	jb     2066 <free+0x26>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    2062:	39 d0                	cmp    %edx,%eax
    2064:	72 32                	jb     2098 <free+0x58>
      break;
  if(bp + bp->s.size == p->s.ptr){
    2066:	8b 73 fc             	mov    -0x4(%ebx),%esi
    2069:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    206c:	39 fa                	cmp    %edi,%edx
    206e:	74 30                	je     20a0 <free+0x60>
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
    2070:	89 53 f8             	mov    %edx,-0x8(%ebx)
  if(p + p->s.size == bp){
    2073:	8b 50 04             	mov    0x4(%eax),%edx
    2076:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    2079:	39 f1                	cmp    %esi,%ecx
    207b:	74 3a                	je     20b7 <free+0x77>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    207d:	89 08                	mov    %ecx,(%eax)
  freep = p;
    207f:	a3 64 29 00 00       	mov    %eax,0x2964
}
    2084:	5b                   	pop    %ebx
    2085:	5e                   	pop    %esi
    2086:	5f                   	pop    %edi
    2087:	5d                   	pop    %ebp
    2088:	c3                   	ret    
    2089:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    2090:	39 d0                	cmp    %edx,%eax
    2092:	72 04                	jb     2098 <free+0x58>
    2094:	39 d1                	cmp    %edx,%ecx
    2096:	72 ce                	jb     2066 <free+0x26>
{
    2098:	89 d0                	mov    %edx,%eax
    209a:	eb bc                	jmp    2058 <free+0x18>
  ...
  if(p + p->s.size == bp){
    ...
    20b5:	75 c6                	jne    207d <free+0x3d>
    p->s.size += bp->s.size;
    20b7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
    20ba:	a3 64 29 00 00       	mov    %eax,0x2964
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    20dc:	8b 15 64 29 00 00    	mov    0x2964,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    20e2:	8d 78 07             	lea    0x7(%eax),%edi
    20e5:	c1 ef 03             	shr    $0x3,%edi
    20e8:	83 c7 01             	add    $0x1,%edi
  if((prevp = freep) == 0){
    20eb:	85 d2                	test   %edx,%edx
    20ed:	0f 84 9d 00 00 00    	je     2190 <malloc+0xc0>
    20f3:	8b 02                	mov    (%edx),%eax
    20f5:	8b 48 04             	mov    0x4(%eax),%ecx
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    if(p->s.size >= nunits){
    20f8:	39 cf                	cmp    %ecx,%edi
    20fa:	76 6c                	jbe    2168 <malloc+0x98>
    20fc:	81 ff 00 10 00 00    	cmp    $0x1000,%edi
    2102:	bb 00 10 00 00       	mov    $0x1000,%ebx
    2107:	0f 43 df             	cmovae %edi,%ebx
  p = sbrk(nu * sizeof(Header));
    210a:	8d 34 dd 00 00 00 00 	lea    0x0(,%ebx,8),%esi
    2111:	eb 0e                	jmp    2121 <malloc+0x51>
    2113:	90                   	nop
    2114:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    2118:	8b 02                	mov    (%edx),%eax
    if(p->s.size >= nunits){
    211a:	8b 48 04             	mov    0x4(%eax),%ecx
    211d:	39 f9                	cmp    %edi,%ecx
    211f:	73 47                	jae    2168 <malloc+0x98>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    2121:	39 05 64 29 00 00    	cmp    %eax,0x2964
    2127:	89 c2                	mov    %eax,%edx
    2129:	75 ed                	jne    2118 <malloc+0x48>
  p = sbrk(nu * sizeof(Header));
    212b:	83 ec 0c             	sub    $0xc,%esp
    212e:	56                   	push   %esi
    212f:	e8 66 fc ff ff       	call   1d9a <sbrk>
  if(p == (char*)-1)
    2134:	83 c4 10             	add    $0x10,%esp
    2137:	83 f8 ff             	cmp    $0xffffffff,%eax
    213a:	74 1c                	je     2158 <malloc+0x88>
  hp->s.size = nu;
    213c:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    213f:	83 ec 0c             	sub    $0xc,%esp
    2142:	83 c0 08             	add    $0x8,%eax
    2145:	50                   	push   %eax
    2146:	e8 f5 fe ff ff       	call   2040 <free>
  return freep;
    214b:	8b 15 64 29 00 00    	mov    0x2964,%edx
      if((p = morecore(nunits)) == 0)
    2151:	83 c4 10             	add    $0x10,%esp
    2154:	85 d2                	test   %edx,%edx
    2156:	75 c0                	jne    2118 <malloc+0x48>
        return 0;
  }
}
    ...
    2160:	5d                   	pop    %ebp
    2161:	c3                   	ret    
    2162:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      if(p->s.size == nunits)
    2168:	39 cf                	cmp    %ecx,%edi
    216a:	74 54                	je     21c0 <malloc+0xf0>
        p->s.size -= nunits;
    216c:	29 f9                	sub    %edi,%ecx
    216e:	89 48 04             	mov    %ecx,0x4(%eax)
        p += p->s.size;
    2171:	8d 04 c8             	lea    (%eax,%ecx,8),%eax
        p->s.size = nunits;
    2174:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    2177:	89 15 64 29 00 00    	mov    %edx,0x2964
}
    217d:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return (void*)(p + 1);
    ...
    2187:	c3                   	ret    
    2188:	90                   	nop
    2189:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
    2190:	c7 05 64 29 00 00 68 	movl   $0x2968,0x2964
    2197:	29 00 00 
    219a:	c7 05 68 29 00 00 68 	movl   $0x2968,0x2968
    21a1:	29 00 00 
    base.s.size = 0;
    21a4:	b8 68 29 00 00       	mov    $0x2968,%eax
    21a9:	c7 05 6c 29 00 00 00 	movl   $0x0,0x296c
    21b0:	00 00 00 
    21b3:	e9 44 ff ff ff       	jmp    20fc <malloc+0x2c>
    21b8:	90                   	nop
    21b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        prevp->s.ptr = p->s.ptr;
    21c0:	8b 08                	mov    (%eax),%ecx
    21c2:	89 0a                	mov    %ecx,(%edx)
    21c4:	eb b1                	jmp    2177 <malloc+0xa7>
    21c6:	66 90                	xchg   %ax,%ax
    21c8:	66 90                	xchg   %ax,%ax
    21ca:	66 90                	xchg   %ax,%ax
    21cc:	66 90                	xchg   %ax,%ax
...
xchg(volatile uint *addr, uint newval)
{
  ...
  asm volatile("lock; xchgl %0, %1" :
    21d1:	b9 01 00 00 00       	mov    $0x1,%ecx
    21d6:	89 e5                	mov    %esp,%ebp
    21d8:	8b 55 08             	mov    0x8(%ebp),%edx
    21db:	90                   	nop
    21dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    21e0:	89 c8                	mov    %ecx,%eax
    21e2:	f0 87 02             	lock xchg %eax,(%edx)
  // The xchg is atomic.
  while(xchg(&lk->locked, 1) != 0)
    21e5:	85 c0                	test   %eax,%eax
    21e7:	75 f7                	jne    21e0 <uacquire+0x10>
    ;
  ...
  __sync_synchronize();
    21e9:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
}
    21ee:	5d                   	pop    %ebp
    21ef:	c3                   	ret    
...
void urelease (struct uspinlock *lk) {
  ...
  __sync_synchronize();
    21f6:	f0 83 0c 24 00       	lock orl $0x0,(%esp)

  // Release the lock, equivalent to lk->locked = 0.
  // This code can't use a C assignment, since it might
  // not be atomic. A real OS would use C atomics here.
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
    21fb:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
    2201:	5d                   	pop    %ebp
    2202:	c3                   	ret    
