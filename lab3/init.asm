...
main(void)
{
  ...
  if(open("console", O_RDWR) < 0){
    ...
    1012:	6a 02                	push   $0x2
    1014:	68 34 18 00 00       	push   $0x1834
  ...
  for(;;){
    ...
    104b:	68 3c 18 00 00       	push   $0x183c
    1050:	6a 01                	push   $0x1
    ...
    1080:	68 7b 18 00 00       	push   $0x187b
    1085:	6a 01                	push   $0x1
    ...
    1091:	53                   	push   %ebx
    1092:	53                   	push   %ebx
    1093:	68 4f 18 00 00       	push   $0x184f
    1098:	6a 01                	push   $0x1
    ...
    10a4:	50                   	push   %eax
    10a5:	50                   	push   %eax
    10a6:	68 74 1b 00 00       	push   $0x1b74
    10ab:	68 62 18 00 00       	push   $0x1862
    10b0:	e8 c5 02 00 00       	call   137a <exec>
      printf(1, "init: exec sh failed\n");
    10b5:	5a                   	pop    %edx
    10b6:	59                   	pop    %ecx
    10b7:	68 65 18 00 00       	push   $0x1865
    10bc:	6a 01                	push   $0x1
    ...
    10c9:	6a 01                	push   $0x1
    10cb:	6a 01                	push   $0x1
    10cd:	68 34 18 00 00       	push   $0x1834
    10d2:	e8 b3 02 00 00       	call   138a <mknod>
    open("console", O_RDWR);
    10d7:	58                   	pop    %eax
    10d8:	5a                   	pop    %edx
    10d9:	6a 02                	push   $0x2
    10db:	68 34 18 00 00       	push   $0x1834
    ...
    1409:	85 d2                	test   %edx,%edx
{
  ...
  do{
    ...
    1437:	f7 f1                	div    %ecx
    1439:	0f b6 92 8c 18 00 00 	movzbl 0x188c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1654:	e9 8f fe ff ff       	jmp    14e8 <printf+0x48>
          s = "(null)";
    1659:	bb 84 18 00 00       	mov    $0x1884,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1671:	a1 7c 1b 00 00       	mov    0x1b7c,%eax
{
  ...
  freep = p;
    16af:	a3 7c 1b 00 00       	mov    %eax,0x1b7c
}
    16b4:	5b                   	pop    %ebx
    16b5:	5e                   	pop    %esi
    16b6:	5f                   	pop    %edi
    ...
    16c6:	72 ce                	jb     1696 <free+0x26>
{
  ...
  freep = p;
    16ea:	a3 7c 1b 00 00       	mov    %eax,0x1b7c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    170c:	8b 15 7c 1b 00 00    	mov    0x1b7c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1751:	39 05 7c 1b 00 00    	cmp    %eax,0x1b7c
  ...
  return freep;
    177b:	8b 15 7c 1b 00 00    	mov    0x1b7c,%edx
    ...
    17a4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    17a7:	89 15 7c 1b 00 00    	mov    %edx,0x1b7c
}
    ...
    base.s.ptr = freep = prevp = &base;
    17c0:	c7 05 7c 1b 00 00 80 	movl   $0x1b80,0x1b7c
    17c7:	1b 00 00 
    17ca:	c7 05 80 1b 00 00 80 	movl   $0x1b80,0x1b80
    17d1:	1b 00 00 
    base.s.size = 0;
    17d4:	b8 80 1b 00 00       	mov    $0x1b80,%eax
    17d9:	c7 05 84 1b 00 00 00 	movl   $0x0,0x1b84
    17e0:	00 00 00 
