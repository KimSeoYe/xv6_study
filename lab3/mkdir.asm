...
main(int argc, char *argv[])
{
  ...
  exit();
    ...
    1053:	68 db 17 00 00       	push   $0x17db
    1058:	6a 02                	push   $0x2
    ...
    1399:	85 d2                	test   %edx,%edx
{
  ...
  do{
    ...
    13c7:	f7 f1                	div    %ecx
    13c9:	0f b6 92 00 18 00 00 	movzbl 0x1800(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    15e4:	e9 8f fe ff ff       	jmp    1478 <printf+0x48>
          s = "(null)";
    15e9:	bb f7 17 00 00       	mov    $0x17f7,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1601:	a1 f0 1a 00 00       	mov    0x1af0,%eax
{
  ...
  freep = p;
    163f:	a3 f0 1a 00 00       	mov    %eax,0x1af0
}
    1644:	5b                   	pop    %ebx
    1645:	5e                   	pop    %esi
    1646:	5f                   	pop    %edi
    ...
    1656:	72 ce                	jb     1626 <free+0x26>
{
  ...
  freep = p;
    167a:	a3 f0 1a 00 00       	mov    %eax,0x1af0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    169c:	8b 15 f0 1a 00 00    	mov    0x1af0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    16e1:	39 05 f0 1a 00 00    	cmp    %eax,0x1af0
  ...
  return freep;
    170b:	8b 15 f0 1a 00 00    	mov    0x1af0,%edx
    ...
    1734:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
    1737:	89 15 f0 1a 00 00    	mov    %edx,0x1af0
}
    ...
    base.s.ptr = freep = prevp = &base;
    1750:	c7 05 f0 1a 00 00 f4 	movl   $0x1af4,0x1af0
    1757:	1a 00 00 
    175a:	c7 05 f4 1a 00 00 f4 	movl   $0x1af4,0x1af4
    1761:	1a 00 00 
    base.s.size = 0;
    1764:	b8 f4 1a 00 00       	mov    $0x1af4,%eax
    1769:	c7 05 f8 1a 00 00 00 	movl   $0x0,0x1af8
    1770:	00 00 00 
