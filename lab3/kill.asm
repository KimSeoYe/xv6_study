...
main(int argc, char **argv)
{
  ...
  exit();
    ...
    1049:	50                   	push   %eax
    104a:	50                   	push   %eax
    104b:	68 a4 17 00 00       	push   $0x17a4
    1050:	6a 02                	push   $0x2
    ...
    1379:	85 d2                	test   %edx,%edx
{
  ...
  do{
    ...
    13a7:	f7 f1                	div    %ecx
    13a9:	0f b6 92 c0 17 00 00 	movzbl 0x17c0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    15c4:	e9 8f fe ff ff       	jmp    1458 <printf+0x48>
          s = "(null)";
    15c9:	bb b8 17 00 00       	mov    $0x17b8,%ebx
        while(*s != 0){
    ...
    15e1:	a1 ac 1a 00 00       	mov    0x1aac,%eax
{
  ...
  freep = p;
    161f:	a3 ac 1a 00 00       	mov    %eax,0x1aac
}
    1624:	5b                   	pop    %ebx
    1625:	5e                   	pop    %esi
    1626:	5f                   	pop    %edi
    ...
    1636:	72 ce                	jb     1606 <free+0x26>
{
  ...
  freep = p;
    165a:	a3 ac 1a 00 00       	mov    %eax,0x1aac
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    167c:	8b 15 ac 1a 00 00    	mov    0x1aac,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    16c1:	39 05 ac 1a 00 00    	cmp    %eax,0x1aac
  ...
  return freep;
    16eb:	8b 15 ac 1a 00 00    	mov    0x1aac,%edx
    ...
    base.s.ptr = freep = prevp = &base;
    1730:	c7 05 ac 1a 00 00 b0 	movl   $0x1ab0,0x1aac
    1737:	1a 00 00 
    173a:	c7 05 b0 1a 00 00 b0 	movl   $0x1ab0,0x1ab0
    1741:	1a 00 00 
    base.s.size = 0;
    1744:	b8 b0 1a 00 00       	mov    $0x1ab0,%eax
    1749:	c7 05 b4 1a 00 00 00 	movl   $0x0,0x1ab4
    1750:	00 00 00 
